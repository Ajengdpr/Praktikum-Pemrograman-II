...
public class Negara {
    ...
    public String getTanggalKemerdekaan() {
        String bulanKemerdekaanStr = getNamaBulan(bulanKemerdekaan);
        return "Deklarasi Kemerdekaan pada Tanggal " + tanggalKemerdekaan + " " + bulanKemerdekaanStr + " " + tahunKemerdekaan;
    }
